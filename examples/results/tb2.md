...
|----|----------|---------|-------------|-------------|-------------|-------------|------|------|-----|
| 16 | docker   | 1961.1s | 19.8s (16%) | 39.1s (31%) | 57.5s (45%) | 10.4s  (8%) | 82   | 7    |
| 16 | nitrobox | 1029.5s | 17.9s (22%) | 37.6s (46%) | 25.6s (31%) | 0.5s  (1%)  | 82   | 7    |

**Cold wall-clock speedup: 1.90x** (33 min → 17 min)

## Hot Start (caches warm)

| C  | Env      | Wall    | EnvSetup   | Agent       | Verify      | Teardown    | Pass | Fail | 
|----|----------|---------|------------|-------------|-------------|-------------|------|------|
| 16 | docker   | 1961.8s | 3.3s  (2%) | 52.7s (39%) | 63.5s (47%) | 15.6s (12%) | 82   | 7    |
| 16 | nitrobox | 931.2s  | 0.7s  (1%) | 28.2s (51%) | 25.4s (46%) | 1.1s  (2%)  | 82   | 7    |
